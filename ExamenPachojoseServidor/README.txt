...
a persistence unit "ExamenPachojoseServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenPachojoseServidor\pom.xml":
...
artifact ("ExamenPachojoseServidor.war") is already built. You can build
